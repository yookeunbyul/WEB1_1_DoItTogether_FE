  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          'relative p-0 text-center text-gray1 font-body focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-white03 [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected].day-range-end)]:rounded-r-full w-full',
          props.mode === 'range'
        ...
        day_today: '',
        day_outside:
          'day-outside text-gray3 aria-selected:bg-accent/50 aria-selected:text-muted-foreground',
