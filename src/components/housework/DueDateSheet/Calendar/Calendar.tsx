  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        cell: cn(
          'relative p-0 text-center text-gray1 font-body focus-within:relative focus-within:z-20 [&:has([aria-selected])]:bg-white [&:has([aria-selected].day-outside)]:bg-accent/50 [&:has([aria-selected].day-range-end)]:rounded-r-full w-full',
          props.mode === 'range'
