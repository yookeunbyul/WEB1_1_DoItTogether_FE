...
const FingerIcon: React.FC<FingerIconProps> = ({
  ...
  return (
    <svg
      ...
      className={className}
    >
      <rect x='0.5' width='22' height='22' rx='11' fill='#19B4DF' />
      <rect x='4.86523' y='9.15234' width='2.01317' height='6.58071' rx='1' fill='white' />
      <path
        ...
        fill='white'
      />
      <rect x='12.6562' y='8.38428' width='6.4782' height='2.4688' rx='1.2344' fill='white' />
      <path
